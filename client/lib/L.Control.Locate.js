...
(function (factory, window) {
    ...
    var LocateControl = L.Control.extend({
        options: {
            ...
            /** Callback function to invoke after the start method is fired */
            startCallback : function() {},
            /** Callback function to invoke after the stop method is fired */
         ...
         * - removes the marker
         * - invokes a callback function (added by clhenrick)
         */
        stop: function() {
            this._deactivate();
            ...
            if (this.options.stopCallback && typeof this.options.stopCallback === 'function') {
